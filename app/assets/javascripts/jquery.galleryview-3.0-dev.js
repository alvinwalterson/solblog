	...
	*/		
	GalleryView = {
		...
		setPositions: function() {
			...
			switch(this.opts.filmstrip_position) {
				case 'top':
                    ...
                    dom.gv_navWrapPrev.css({ top: navVert, left: fsHorz });
				...
				case 'right':
                    ...
                    dom.gv_navWrapPrev.css({ bottom: navVert, right: navHorz });
				...
				case 'left':
                    ...
                    dom.gv_navWrapPrev.css({ bottom: navVert, left: navHorz });
		...
		enablePanning: function() {
			...
			dom.gv_panel.css('cursor','pointer');
      ...
      dom.gv_navWrapPrev.delegate('div','click.galleryview',function(){
		...
		unbindActions: function() {
            ...
            dom.gv_navWrapPrev.undelegate('div','click.galleryview');
		...
		init: function(options,el) {
			...
			if(this.opts.show_filmstrip) {
                dom.gv_navWrapPrev.append(dom.gv_navPrev);
                dom.gv_gallery.append ( dom.gv_navWrapPrev);
				...
				dom.gv_navWrap.append(dom.gv_navNext);
                dom.gv_gallery.append ( dom.gv_navWrap);
			}
